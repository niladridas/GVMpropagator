%--------------------------------------------------------------------------
%
% DEInteg: Numerical integration methods for ordinaray differential
%          equations
%          This module provides implemenation of the variable order
%          variable stepsize multistep method of Shampine & Gordon.
% 
% Reference:
...
% 
%--------------------------------------------------------------------------
function y = DEInteg(func,t,tout,relerr,abserr,n_eqn,y)
