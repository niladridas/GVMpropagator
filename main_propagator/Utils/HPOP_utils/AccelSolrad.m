...
% 
%--------------------------------------------------------------------------
function a = AccelSolrad(r,r_Earth,r_Moon,r_Sun,r_SunSSB,Area,mass,Cr,P0,AU,R_Earth, R_Sun, R_Moon)
...
[nu,~] = Shadow(pccor,ccor,pscor,sbcor,bcor,sbpcor,R_Earth, R_Sun, R_Moon);
